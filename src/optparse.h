...
#define OPTPARSE_API
     ...
     */
    OPTPARSE_API void optparse_init(struct optparse *options, char **argv);
     ...
     */
    OPTPARSE_API int optparse(struct optparse *options, const char *optstring);
     ...
     */
    OPTPARSE_API int optparse_long(struct optparse *options,
     ...
     */
    OPTPARSE_API char *optparse_arg(struct optparse *options);
                                   ...
                                   const struct optparse_long *longopts, int *longindex)
    {
        ...
        for (int i = 0; !optparse_longopts_end(longopts, i); i++)
        {
            ...
            if (optparse_longopts_match(name, option))
            {
                ...
                char *arg = optparse_longopts_arg(option);

...
class testmodem(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "test modem", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("test modem")
        ...
        self.settings = Qt.QSettings("GNU Radio", "testmodem")
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(0.0628318, 4, False)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(6, self.samp_rate, 1200, .35, 65))




def main(top_block_cls=testmodem, options=None):
